...
/* globals contract, Colony, RootColony, ColonyShareLedger web3, assert */
...
contract('Colony', function (accounts) {
  ...
  beforeEach(function (done) {
    RootColony.new({from:mainaccount, value: 3000000000})
    .then(function(rootColonyContract){
      rootColony = rootColonyContract;
      return rootColony;
    })
    .then(function(){
      return rootColony.createColony(100, { from: mainaccount, value: 3000000000 });
    })
      .then(function() {
...
describe('when created', function () {
  it('deployed user should be admin', function (done) {
    colony.getUserInfo.call(mainaccount)
    .then(function (admin) {
