...
HARDHAT_CHAIN_ID=$CHAIN_ID yarn start:blockchain:client hardhat &
...
PK="0x0355596cdb5e5242ad082c4fe3f8bbe48c9dba843fe1f99dd8272f487e70efae" NODE_URL=http://127.0.0.1:$PORT npx hardhat --network custom deploy
