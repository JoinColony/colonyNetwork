...
sed -i.bak "s/contract UpdatedColony is UpdatedColonyStorage, PatriciaTreeProofs, GetChainId {/contract UpdatedColony is UpdatedColonyStorage, PatriciaTreeProofs, GetChainId {function isUpdated() external pure returns(bool) {return true;}/g" ./contracts/colony/UpdatedColony.sol
