...
sed -i.bak "s/contract UpdatedColony is BasicMetaTransaction, Multicall, UpdatedColonyStorage, PatriciaTreeProofs {/contract UpdatedColony is BasicMetaTransaction, Multicall, UpdatedColonyStorage, PatriciaTreeProofs {function isUpdated() external pure returns(bool) {return true;}/g" ./contracts/colony/UpdatedColony.sol
