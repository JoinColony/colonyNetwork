  ...
  async respondToChallenge() {
    ...
    const tx = await repCycle.respondToChallenge(
      [
        ...
        this.responseToFalsify === 3 ? this.responseValue : lastAgreeJustifications.nextUpdateProof.nLeaves,
        this.responseToFalsify === 4 ? this.responseValue : ReputationMinerTestWrapper.getHexString(agreeStateBranchMask),
        this.responseToFalsify === 5 ? this.responseValue : firstDisagreeJustifications.justUpdatedProof.nLeaves,
        this.responseToFalsify === 6 ? this.responseValue : ReputationMinerTestWrapper.getHexString(disagreeStateBranchMask),
        this.responseToFalsify === 7 ? this.responseValue : logEntryNumber,
        this.responseToFalsify === 8 ? this.responseValue : "0",
        this.responseToFalsify === 9 ? this.responseValue : lastAgreeJustifications.originReputationProof.branchMask,
        this.responseToFalsify === 10 ? this.responseValue : lastAgreeJustifications.nextUpdateProof.reputation,
        this.responseToFalsify === 11 ? this.responseValue : lastAgreeJustifications.nextUpdateProof.uid,
        this.responseToFalsify === 12 ? this.responseValue : firstDisagreeJustifications.justUpdatedProof.reputation,
        this.responseToFalsify === 13 ? this.responseValue : firstDisagreeJustifications.justUpdatedProof.uid,
        this.responseToFalsify === 14 ? this.responseValue : lastAgreeJustifications.originReputationProof.reputation,
        this.responseToFalsify === 15 ? this.responseValue : lastAgreeJustifications.originReputationProof.uid,
        this.responseToFalsify === 16 ? this.responseValue : lastAgreeJustifications.childReputationProof.branchMask,
        this.responseToFalsify === 17 ? this.responseValue : lastAgreeJustifications.childReputationProof.reputation,
        this.responseToFalsify === 18 ? this.responseValue : lastAgreeJustifications.childReputationProof.uid,
        this.responseToFalsify === 19 ? this.responseValue : "0",
        this.responseToFalsify === 20 ? this.responseValue : lastAgreeJustifications.adjacentReputationProof.branchMask,
        this.responseToFalsify === 21 ? this.responseValue : lastAgreeJustifications.adjacentReputationProof.reputation,
        this.responseToFalsify === 22 ? this.responseValue : lastAgreeJustifications.adjacentReputationProof.uid,
        this.responseToFalsify === 23 ? this.responseValue : "0",
        this.responseToFalsify === 24 ? this.responseValue : lastAgreeJustifications.originAdjacentReputationProof.reputation,
        this.responseToFalsify === 25 ? this.responseValue : lastAgreeJustifications.childAdjacentReputationProof.reputation
      ],
      [
