...
class ReputationMiner {
  ...
  async addSingleReputationUpdate(updateNumber, repCycle, blockNumber, checkForReplacement) {
    ...
    if (updateNumber.lt(this.nReputationsBeforeLatestLog)) {
      ...
      // These are the numerator and the denominator of the fraction we wish to reduce the reputation by. It is very slightly less than one.
      const numerator   = ethers.utils.bigNumberify("999679150010888");
