...
contract ReputationMiningCycleCommon is ReputationMiningCycleStorage, PatriciaTreeProofs, DSMath {
  ...
  uint256 constant Y =
    UINT256_MAX / (CHALLENGE_RESPONSE_WINDOW_DURATION - ALL_ENTRIES_ALLOWED_END_OF_WINDOW);
  ...
  function expectedProofLength(uint256 _nNodes, uint256 _node) internal pure returns (uint256) {
    // solium-disable-line security/no-assign-params
    _nNodes -= 1;
