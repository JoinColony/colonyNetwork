...
contract ENSRegistry is ENS {
  ...
  function setOwner(bytes32 node, address owner) public onlyOwner(node) {
  ...
  function setResolver(bytes32 node, address resolver) public onlyOwner(node) {
  ...
  function setTTL(bytes32 node, uint64 ttl) public onlyOwner(node) {
