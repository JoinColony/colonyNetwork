...
contract FakeUpdatedColony is Modifiable, IUpgradable  {
    ...
    address _eternalStorage)
  {
    ...
    onlyAdmins
    {
      ...
      if (eternalStorage.transferFrom(msg.sender, this, tokensWei)) {
    ...
    onlyAdmins
    {
      ...
      if (taskTokens > 0)
      {
        ...
        if (eternalStorage.transfer(paymentAddress, payout) && eternalStorage.transfer(rootColonyResolver.rootColonyAddress(), fee)) {
          var reservedTokensWei = eternalStorage.getReservedTokensWei();
    ...
    function generateTokensWei(uint256 tokensWei)
    onlyAdmins
    refundEtherSentByAccident
    {
      eternalStorage.generateTokensWei(tokensWei);
    }
    ...
    onlyAdminsOrigin
    {
      ...
      if(tokensBalance > 0 && !eternalStorage.transfer(newColonyAddress_, tokensBalance)) {
        throw;
      }
