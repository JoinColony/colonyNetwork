...
/* globals FakeNewRootColony, RootColony, Colony, RootColonyResolver, ColonyFactory, EternalStorage, ColonyTokenLedger
*/
...
module.exports = {
  ...
  setDefaultGas : function(){
    ...
    ColonyTokenLedger.defaults({gasPrice: _GAS_PRICE_, gas:_GAS_TO_SPEND_});
  }
};
