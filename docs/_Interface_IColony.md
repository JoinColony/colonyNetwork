...
|Name|Type|Description|
|---|---|---|
|balance|uint256| Funding pot supply 
...
|Name|Type|Description|
|---|---|---|
|count|uint256| The funding pots 
...
|Name|Type|Description|
|---|---|---|
|nonce|uint256| The current task change 
...
|key|bytes| Some Reputation hash tree 
|value|bytes| Reputation 
