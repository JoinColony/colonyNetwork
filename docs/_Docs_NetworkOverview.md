...
* Reputation will not mediate colony member's ability to interact with certain functions. Instead, the [authority roles](/colonyjs/topics-managing-permissions/) will be used to grant the FOUNDER and ADMIN roles the ability to call certain priviledged functions such as creating a new task.
