...
Colony is designed to be permissive. The [reputation system](/colonynetwork/tldr-reputation/) mediates the extent to which members may influence a colony, but beyond that constraint, members are free to take executive action with most colony matters without any aproval from a management authority.
