...
class MaliciousReputationMiningClient4 extends ReputationMiningClient {
  // This client will supply the wrong
  constructor(minerAddress, realProviderPort, amountToFalsify) {
...
export default MaliciousReputationMiningClient4;
